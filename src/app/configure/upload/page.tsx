...
const Page = () => {
    ...
    const onDropRejected = (rejectedFiles: FileRejection[]) => {
        ...
        toast({
            title: `${file.file.type} Tipo de archivo no soportado.`,
            description: "Por favor elige PNG, JPG o JPEG en su lugar.",
            variant: "destructive"
        })
    }
                        ...
                        justify-center"
                            ...
                            text-zinc-700">
                                {isUploading ? (
                                    ...
                                    <p>
                                        <span className="font-semibold">Arrastra un archivo</span>{" "}
                                        Para subirlo
                                    </p>
                                ) : (
                                    <p>
